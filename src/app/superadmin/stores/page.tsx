...
export default function StoresPage() {
  ...
  const filteredStores = stores.filter(
    (store) =>
      ...
      store.company.companyName.toLowerCase().includes(searchQuery.toLowerCase())
  );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Gérez tous les magasins de la plateforme
          </p>
        </div>
        <Button onClick={() => router.push("/superadmin/stores/new")}>
            ...
            <div className="space-y-4">
              {filteredStores.map((store) => (
                <div
                  ...
                  onClick={() => router.push(`/superadmin/stores/${store.id}`)}
                >
